...
#######################run user-hmmer gene assembler##################################
../meangs.py -1 SRR039541.3_1.clean.fq.gz -2 SRR039541.3_2.clean.fq.gz -o HumanGene -t 16 -n 0 -i 300 --deepin --species_class user-hmm
